                            ...
                            <div class="feed-item-inner">
                                ...
                                <div class="feed-main">
                                    ...
                                    <div class="feed-content" data-za-module="AnswerItem">
                                        ...
                                        <h2 class="feed-title">
                                            <a class="question_link" target="_blank" href="https://nowcoder.com/question/19857995#answer-389034">${vo.question.getTitle()!}</a></h2>
                                        ...
                                        <div class="expandable entry-body">
                                            ...
                                            <div class="zm-item-answer-author-info">
                                                ...
                                                <span title="从互联网行业出来在做旅行的前对冲基金从业者" class="bio">，${vo.question.createdDate?string('yyyy年MM月dd日 HH:mm:ss')!}</span></div>
